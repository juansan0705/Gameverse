package com.jsancre.gameverse.channel;
...
public class NotificationHelper extends ContextWrapper {
    private static final String CHANNEL_ID = "com.jsancre.gameverse";
    private static final String CHANNEL_NAME = "Gameverse";

    private NotificationManager mManager;

    public NotificationHelper(Context context) {
        super(context);
        //aqui validamos si el telefono de el usuario tiene una version superior a Android Oreo
    ...
    public NotificationCompat.Builder getNotificationMessage(
        ...
        if (bitmapReceiver == null){
            person1 = new Person.Builder()
                    .setName("Tú") //Poniendo la variable 'usernameReceiver' sale el nombre de el usuario de la sesión
                    .setIcon(IconCompat.createWithResource(getApplicationContext(),R.drawable.ic_person_gray))
                    .build();
        }
        else{
            person1 = new Person.Builder()
