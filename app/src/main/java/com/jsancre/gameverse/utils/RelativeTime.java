...
/**
 * Clase que gestiona todos los timestamp de la aplicación
 */
public class RelativeTime extends Application {

    // Almacenamos los tiempos para trabajar con ellos en los métodos de calculo.
    ...
    // Filtramos el tiempo de subida de las publicaciones
